...
test("Test extend with simple objects", function() {
  var inputFormula = 'IF("foo" = "foo", "foo", "bar")';
  var excpected = 'IF\n(\n\t"foo"= "foo",\n\t"foo",\n\t"bar"\n)';
  equals(excelFormulaUtilities.parser.formatFormula(inputFormula), excpected, "Simple formating example.");
...
test("formula to csharp test", function() {
  var inputFormula = 'IF("foo" = "foo", "foo", "bar")';
  var excpected = '';
  equals(excelFormulaUtilities.parser.formatFormula(inputFormula), excpected, "Simple if example.");
});
